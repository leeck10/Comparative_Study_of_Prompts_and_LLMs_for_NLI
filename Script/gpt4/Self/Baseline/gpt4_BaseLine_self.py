...
def score_for_input(args, premise, hypothesis):
    ...
    prompts = None
    prefix = "Infer that the relationship between premises and hypothesis is ‘contradiction’, ‘entailment’, or ‘neutral’, as in the following example.When answering, please do not provide any other explanation, but only predict one of the following: 'contradiction', 'entailment', or 'neutral'."
    _pred =""
    print(3)
    # Chat 기반 모델 
