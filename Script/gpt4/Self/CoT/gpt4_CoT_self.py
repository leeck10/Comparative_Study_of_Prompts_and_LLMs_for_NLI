...
def main():
    ...
    parser.add_argument('--example-path', type=str, default='/home/cyh/GKP-master/chl/gpt4/Self/CoT/data4prompt_4shot.txt', help="In-Context 환경, 태스크 예시 경로")
    parser.add_argument('--label_type', type=str,)
    args = parser.parse_args()
    
    if args.task == 'knowledge':
        args.input_path = '/home/cyh/GKP-master/chl/Self/input.json'
    args.output_path = f'./gpt4_CoT_selfCon_4shot.json'
    data=[]
    new_li = []
    ...
    with open(args.output_path, 'w') as out_f:  
        for d in data:
            ...
            path, Answer = self_con(args,d['premise'], d['hypothesis'])
            empty['path'] = path
            empty['Answer'] = Answer
            new_li.append(empty)
