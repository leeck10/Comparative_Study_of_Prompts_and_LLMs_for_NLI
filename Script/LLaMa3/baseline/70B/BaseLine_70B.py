...
def response(args, premise, hypothesis):
    ...
    prefix = "Infer that the relationship between premises and hypothesis is ‘contradiction’, ‘entailment’, or ‘neutral’. When answering, please do not provide any other explanation, but only predict one of the following: 'contradiction', 'entailment', or 'neutral'."
    messages = [
