...
def response(args, premise, hypothesis):
    ...
    prefix = "Infer that the relationship between premises and hypothesis is ‘contradiction’, ‘entailment’, or ‘neutral’. Use 'label:' at the end of your answer and only one of the three label types: 'contradiciton', 'entailment', or 'neutral'."
