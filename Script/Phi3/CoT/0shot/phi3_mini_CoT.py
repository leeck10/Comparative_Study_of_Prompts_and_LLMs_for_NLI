...
def response(args, premise, hypothesis):
    ...
    prefix = "Infer that the relationship between premises and hypothesis is ‘contradiction’, ‘entailment’, or ‘neutral’. Let's think step by step. Explain the reason for your inference and at the end, answer with one of the following: 'contradiction', 'entailment', or 'neutral'."
