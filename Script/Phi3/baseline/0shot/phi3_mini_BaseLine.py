...
def response(args, premise, hypothesis):
    ...
    prefix = "Refer to the explanation and predict whether the relationship between premise and hypothesis is 'contradiction', 'entailment', or 'neutral', but never add any explanation other than the label name."
    '''
    messages = [
