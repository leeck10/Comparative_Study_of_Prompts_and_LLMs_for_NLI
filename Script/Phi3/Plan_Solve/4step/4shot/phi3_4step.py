...
def response(args, premise, hypothesis):
    ...
    prefix = "Solve the problem step by step, following a plan to predict whether the hypothesis is “contradiction” “entailment” or “neutral” with respect to the premises, Solve everything up to step 4 and then let me know the inferred result in the form of ‘Label:’, as shown in the example."
    messages = [
