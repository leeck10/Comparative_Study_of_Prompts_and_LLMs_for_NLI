...
def main():
    ...
    parser.add_argument('--example-path', type=str, default='/home/cyh/GKP-master/chl/Self/4step_ps/4step_prompt.txt', help="In-Context 환경, 태스크 예시 경로")
    parser.add_argument('--label_type', type=str,)
    args = parser.parse_args()
    
    if args.task == 'knowledge':
        args.input_path = '/home/cyh/GKP-master/chl/Self/input.json'
    args.output_path = f'./esnli_selfCon_4step_{args.shot}shot.json'
    data = []
    new_li = []
