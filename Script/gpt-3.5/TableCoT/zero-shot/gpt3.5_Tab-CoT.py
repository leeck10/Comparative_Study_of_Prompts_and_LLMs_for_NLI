...
def score_for_input(args, premise, hypothesis):
    ...
    print(2)
    prompts = None
    prefix = "Infer step by step that the relationship between premises and hypothesis is ‘contradiction’, ‘entailment’, or ‘neutral’."
...
def main():
    ...
    args.output_path = f'./esnli_Table_CoT_zero-shot.json'
    data=[]
    new_li = []
