...
def score_for_input(args, premise, hypothesis):
    ...
    print(2)
    prompts = None
    prefix = "Infer whether the relationship between premise and hypothesis corresponds to 'contradiction', 'entailment', or 'neutral'. Let's think step by step. Just tell me the inference results without any additional explanation."
...
def main():
    ...
    args.output_path = f'./esnli_CoT_Zero-shot.json'
    data=[]
    new_li = []
