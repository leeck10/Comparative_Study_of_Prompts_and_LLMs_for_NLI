...
def main():
    ...
    parser.add_argument('--example-path', type=str, default='/home/cyh/GKP-master/chl/Plan_Solve/only_PS/plainPS/4-shot/prompt4inference_ver.ps_4shot.txt', help="In-Context 환경, 태스크 예시 경로")
