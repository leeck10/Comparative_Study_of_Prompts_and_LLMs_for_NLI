...
def main():
    ...
    parser.add_argument('--example-path', type=str, default='/home/cyh/GKP-master/chl/Plan_Solve/only_PS/plainPS/ps_2step/4-shot/prompt4inference_2Step_ps_4shot.txt', help="In-Context 환경, 태스크 예시 경로")
    ...
    args.output_path = f'./esnli_2Step_PS_{args.shot}shot.json'
    data=[]
    new_li = []
